      ...
      <footer className='footer'>
        <div className='footer__top'>
          ...
          <div className='footer__hello'>
            <div className='text-md text-white mb-16'> If you'd like to talk about a project you want help with or need an advice about development or product design, just drop me a message</div>
            <Link to='/contact' className='btn btn--outline btn--green'>
              Fill out the contact form
            </Link>
            <div className='text-md text-white text-center mt-32'>You can also talk to me directly in real time</div>
          </div>
        </div>
